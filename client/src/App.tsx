...
const mockMessages: Record<string, MessageBubbleProps[]> = {
  ...
  "g3": [
    ...
    { id: "mg6", content: "", timestamp: "2:18 PM", isOwn: false, senderName: "Jake", senderAvatar: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=40&h=40&fit=crop", media: { type: "video", url: "https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=500&h=600&fit=crop", duration: "2:30" } },
  ...
  "g4": [
    ...
    { id: "bc9", content: "", timestamp: "10:25 AM", isOwn: false, senderName: "Jessica", senderAvatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=40&h=40&fit=crop", media: { type: "video", url: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=500&h=600&fit=crop", duration: "4:15" } },
  ...
  "6": [
    ...
    { id: "db7", content: "", timestamp: "Yesterday", isOwn: false, senderName: "David", senderAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop", media: { type: "video", url: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&h=600&fit=crop", duration: "1:50" } },
