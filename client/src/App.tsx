...
const mockMessages: Record<string, MessageBubbleProps[]> = {
  "1": [
    ...
    { id: "m5", content: "Here's a voice note for you", timestamp: "2:34 PM", isOwn: false, senderName: "Alice", media: { type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3", duration: "0:30" } },
  ...
  "2": [
    ...
    { id: "m10", content: "", timestamp: "12:30 PM", isOwn: false, senderName: "Sarah", media: { type: "video", url: "https://images.unsplash.com/photo-1611339555312-e607c90352fd?w=500&h=400&fit=crop", duration: "2:45", fileSize: "45.2 MB", views: 234 } },
    { id: "m11", content: "I'll review the changes today.", timestamp: "12:45 PM", isOwn: false, senderName: "Sarah" },
    { id: "m12", content: "", timestamp: "1:00 PM", isOwn: false, senderName: "Mike", media: { type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3", duration: "3:15" } },
  ...
  "4": [
    ...
    { id: "m23", content: "", timestamp: "10:06 AM", isOwn: false, senderName: "Carol", media: { type: "image", url: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=500&h=400&fit=crop" } },
    { id: "m24", content: "Beautiful! Where was this?", timestamp: "10:10 AM", isOwn: true, status: "read" },
    { id: "m25", content: "", timestamp: "10:15 AM", isOwn: false, senderName: "Carol", media: { type: "video", url: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=500&h=400&fit=crop", duration: "1:35", fileSize: "12.5 MB" } },
  ],
  "5": [
