...
const mockMessages: Record<string, MessageBubbleProps[]> = {
  "1": [
    ...
    { id: "m3", content: "Check out this sunset photo!", timestamp: "2:32 PM", isOwn: false, senderName: "Alice", media: { type: "image", url: "https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?w=500&h=400&fit=crop" } },
    { id: "m4", content: "Wow, that's beautiful!", timestamp: "2:33 PM", isOwn: true, status: "read" },
    { id: "m5", content: "Check this article out", timestamp: "2:34 PM", isOwn: false, senderName: "Alice", media: { type: "link", url: "https://example.com/tech-article", title: "Latest Tech Trends", description: "Discover the newest trends in technology" } },
    { id: "m6", content: "Are you coming to the party tonight?", timestamp: "2:35 PM", isOwn: false, senderName: "Alice" },
    { id: "m7", content: "Yes! I'll be there 🎉", timestamp: "2:36 PM", isOwn: true, status: "read" },
  ],
  "2": [
    { id: "m8", content: "Team, I've updated the project timeline.", timestamp: "12:00 PM", isOwn: false, senderName: "Mike" },
    { id: "m9", content: "Looks good to me!", timestamp: "12:15 PM", isOwn: true, status: "read" },
    { id: "m10", content: "Here's the demo video", timestamp: "12:30 PM", isOwn: false, senderName: "Sarah", media: { type: "video", url: "https://commondatastorage.googleapis.com/gtv-videos-library/sample/big_buck_bunny.mp4" } },
    { id: "m11", content: "I'll review the changes today.", timestamp: "12:45 PM", isOwn: false, senderName: "Sarah" },
    { id: "m12", content: "Here's the audio of my ideas", timestamp: "1:00 PM", isOwn: false, senderName: "Mike", media: { type: "audio", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3" } },
    { id: "m13", content: "The presentation is ready for review", timestamp: "1:15 PM", isOwn: false, senderName: "Sarah" },
    { id: "m14", content: "Great work everyone!", timestamp: "1:20 PM", isOwn: true, status: "read" },
  ],
  "3": [
    { id: "m15", content: "Can you help me with this code review?", timestamp: "Yesterday", isOwn: false, senderName: "Bob" },
    { id: "m16", content: "Sure! Send me the PR link", timestamp: "Yesterday", isOwn: true, status: "read" },
    { id: "m17", content: "Check out this amazing resource", timestamp: "Yesterday", isOwn: false, senderName: "Bob", media: { type: "link", url: "https://github.com/facebook/react", title: "React Repository", description: "A JavaScript library for building user interfaces" } },
    { id: "m18", content: "Done! Take a look when you can", timestamp: "Yesterday", isOwn: false, senderName: "Bob" },
    { id: "m19", content: "Thanks for your help with the code review!", timestamp: "Yesterday", isOwn: false, senderName: "Bob" },
  ...
  "4": [
    ...
    { id: "m22", content: "Great! Just got back from vacation", timestamp: "10:05 AM", isOwn: false, senderName: "Carol" },
    { id: "m23", content: "Check out our travel photos!", timestamp: "10:06 AM", isOwn: false, senderName: "Carol", media: { type: "image", url: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=500&h=400&fit=crop" } },
    { id: "m24", content: "Beautiful! Where was this?", timestamp: "10:10 AM", isOwn: true, status: "read" },
    { id: "m25", content: "Bali! Found this cool hiking trail. Here's the vlog", timestamp: "10:15 AM", isOwn: false, senderName: "Carol", media: { type: "video", url: "https://commondatastorage.googleapis.com/gtv-videos-library/sample/fortnite.mp4" } },
  ],
  "5": [
    { id: "m26", content: "Family group chat is active!", timestamp: "9:00 AM", isOwn: false, senderName: "Mom" },
    { id: "m27", content: "Don't forget Sunday dinner!", timestamp: "9:05 AM", isOwn: false, senderName: "Mom" },
